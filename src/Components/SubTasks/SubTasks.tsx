    ...
    <div className="p-4 flex w-[100%]  justify-center bg-[#F8F9FA] ">
      {[...Array(1)].map((_, i) => (
        <div key={i} className="mb-3 ">
          <SkeltonLoader
            skeltonHeaderHeight={25}
            marginTop={"50"}
            columns={[300, 100, 300, 300, 100]}
            rows={10}
          />
        </div>
      ))}
      ...
      >
        <SwiperSlide>
          <div className="relative  h-full">
            ...
            {/* SubTasks Content */}
            <div className="bg-white bg-red-500 h-screen overflow-auto max-w-4xl mx-auto my-10 p-6 pt-[0px] rounded-[40px] shadow-md">
              {/* Header */}
              <ReactSVG
                        ...
                        <div className="col-span-1 ">
                          <div className="grid lg:grid-cols-3">
                            ...
                            <div className="col-span-1 mb-[20px]">
                              ...
                              <p>
                                {dayjs(singleData?.created_at).format(
                                  "DD MMMM YYYY"
                                )}
                              </p>
                            </div>
