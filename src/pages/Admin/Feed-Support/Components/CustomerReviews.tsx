...
const CustomerReviews: React.FC = () => {
  return (
    <div className="rounded-xl flex flex-col items-start p-[20px] gap-3 border border-[#0000001A]">
      ...
      <div className="bg-[#F7F8FC] lg:p-[20px] p-0  w-full rounded-[20px]">
        <div className="bg-[#fff] px-[15px] py-[18px] w-full rounded-[20px] grid grid-cols-2">
          <div className="w-full bg-white col-span-2 lg:col-span-1">
            <h3 className="!text-[20px] !font-semibold text-[#252525] ">
              Detailer & Service Info:
            </h3>
