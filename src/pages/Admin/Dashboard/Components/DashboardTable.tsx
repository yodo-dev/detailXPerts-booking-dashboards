...
const DashboardTable: React.FC = ({ tableHeaders, topTable }) => {
  return (
    <table className=" rounded-lg border-separate border-spacing-0 mt-[20px] w-full">
        ...
        {topTable ? (
          <>
            ...
            <tr className="text-start border hover:bg-[#f5f8ff] transition-all duration-300 ease-in-out bg-white">
              ...
              <td className="px-6 py-5 !text-[16px] text-[#252525]">
                <div className="h-[4px] bg-[#8CFAC7] rounded relative ">
                  <div className="h-[100%] w-[30%] bg-[#00E096] rounded"></div>
                  <span className="absolute top-[-7px] right-[-38px] text-[12px] font-normal">
                    25%
                  </span>
                </div>
              ...
              <td className="px-6 py-5 !text-[16px]  text-[#252525] text-center pe-0">
                <span className="border !text-center border-[#00E096] text-[#00E096] font-normal text-[13px] pt-[2px] pb-[2px] ps-[13px] pe-[13px] rounded-lg ">
                  132
                </span>
              </td>
            </tr>
            ...
            <tr className="text-start border hover:bg-[#f5f8ff] transition-all duration-300 ease-in-out bg-white">
              ...
              <td className="px-6 py-5 !text-[16px]  text-[#252525] text-center pe-0">
                <span className="border !text-center border-[#FF8F0D] text-[#FF8F0D] font-normal text-[13px] pt-[2px] pb-[2px] ps-[13px] pe-[13px] rounded-lg ">
                  132
                </span>
              </td>
            </tr>
