...
import { AvailabilityCard } from "@pages/FranchiseDashboard/CustomersFranchise/Components/AvailabilityCard";
import Calendar2 from "@assets/svgs/calendar-2.svg";
const DetailerFranchiseInfo: React.FC = () => {
          ...
          <div className="min-h-screen bg-white border-[#e0e3e8] rounded-xl p-6 md:p-10">
            ...
            <div className="w-full mb-[16px]">
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <div
                  className="w-full bg-[#F5F5F5] rounded-xl flex items-center justify-between px-4 py-3 cursor-pointer"
                  //   onClick={handleOpen}
                >
                  <span
                    className={`text-sm ${
...
export default DetailerFranchiseInfo;
